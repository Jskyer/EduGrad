...
func downloadPaperDraftHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// l := logic.NewDownloadPaperDraftLogic(r.Context(), svcCtx)
		// resp, err := l.DownloadPaperDraft(&req)
		// if err != nil {
		// 	httpx.ErrorCtx(r.Context(), w, err)
		// } else {
