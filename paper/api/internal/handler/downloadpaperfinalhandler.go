...
func downloadPaperFinalHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// l := logic.NewDownloadPaperFinalLogic(r.Context(), svcCtx)
		// resp, err := l.DownloadPaperFinal(&req)
		// if err != nil {
		// 	httpx.ErrorCtx(r.Context(), w, err)
		// } else {
