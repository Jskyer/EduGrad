...
func downloadProposalDraftHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// l := logic.NewDownloadProposalDraftLogic(r.Context(), svcCtx)
		// resp, err := l.DownloadProposalDraft(&req)
		// if err != nil {
		// 	httpx.ErrorCtx(r.Context(), w, err)
		// } else {
