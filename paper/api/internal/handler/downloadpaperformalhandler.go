...
func downloadPaperFormalHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// l := logic.NewDownloadPaperFormalLogic(r.Context(), svcCtx)
		// resp, err := l.DownloadPaperFormal(&req)
		// if err != nil {
		// 	httpx.ErrorCtx(r.Context(), w, err)
		// } else {
